# CPack script that notarizes the packaged DMG
...
execute_process(
    ...
    --apple-id "${CPACK_OSC_NOTARIZATION_APPLE_ID}"
    --team-id "${CPACK_OSC_NOTARIZATION_TEAM_ID}"
    --password "${CPACK_OSC_NOTARIZATION_PASSWORD}"
    --wait
    RESULT_VARIABLE res
    COMMAND_ECHO STDERR
)
