...
namespace
{
    ...
    struct RenderQueueEmplaceArgs final {
        ...
        std::optional<MaterialPropertyBlock> material_property_block;
        std::optional<size_t> submesh_index = 3;
    };
}
