...
# Setup libUBSAN suitable for simbody/OpenSim/Creator
export UBSAN_OPTIONS="abort_on_error=1:print_stacktrace=1:print_summary=1:suppressions=${PWD}/scripts/suppressions_ubsan.supp"
