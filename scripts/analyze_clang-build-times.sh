...
CC=clang CXX=clang++ CXXFLAGS=-ftime-trace cmake -G Ninja -S . -B build-clangbuildanalyzer -DCMAKE_PREFIX_PATH=${PWD}/third_party-install-RelWithDebInfo -DOSC_BUILD_OPENSIMCREATOR=OFF
