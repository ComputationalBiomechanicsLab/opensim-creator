...
# Generates icon files from images that are compatible with Mac's (icns) and
# Windows' (ico) icon systems.
#
# WALKTHROUGH
#
...
#
#     - e.g. (icns) `${THIS} logoBIG.png -o icon.icns`
#     - e.g. (ico)  `${THIS} logoBIG.png -o icon.ico`
#
...
import argparse
import os
from PIL import Image  # must be installed via pip: `pip install Pillow`
