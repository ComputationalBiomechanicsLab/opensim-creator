...
sudo docker run --rm -v ${PWD}:/opynsim quay.io/pypa/manylinux_2_34_x86_64 bash -c 'cd opynsim && PATH=/opt/python/cp312-cp312/bin:$PATH ./scripts/e2e_setup-and-build-unix.sh'
