...
cmake -S third_party -B osc-dependencies-build -G Ninja -DCMAKE_BUILD_TYPE=%OSC_BUILD_TYPE% -DCMAKE_INSTALL_PREFIX=%cd%/osc-dependencies-install -DOSCDEPS_BUILD_OPENBLAS=ON
