...
For example, building a biomechanical model of a dinosaur involves 3D scanning fossils, segmenting/registering bones, identifying reference frames and muscle attachments, rigging/articulating skeletal structures, reconstructing musculature, and running biomechanical simulations [@Bishop:2021]. Such workflows often need to be repeated for different subjects or specimens and may require dynamic simulation of the model to ensure it is balanced and has stable dynamics. While scaling existing models can reduce this effort, developing robust and unbiased scaling procedures that handle diverse shapes, injuries, or deformities remains challenging [@vanDerKruk:2025]; therefore, real-time visual feedback during model building, dynamic simulation, and scaling is a powerful feature for model creation, verification, and validation.
