...
namespace
{
    ...
    std::shared_ptr<TJoint> JointWithCoords(std::initializer_list<osc::CStringView> names)
    {
        ...
        int i = 0;
        for (const osc::CStringView& name : names) {
