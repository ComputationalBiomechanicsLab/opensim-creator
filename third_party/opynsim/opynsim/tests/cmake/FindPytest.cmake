...
#
# It exposes the 'pytest_discover_tests' function, which adds CTest
...
# Use the Python environment that the caller specifies (or defaults)
find_package(Python REQUIRED)

# Run `pytest` in the callers current python environment (which they may
# have customized with `Python_ROOT_DIR`)
execute_process(
...
# else: probably can't find pytest

# Make this script compatible with `find_package`.
find_package_handle_standard_args(
    Pytest
    REQUIRED_VARS PYTEST_VERSION
