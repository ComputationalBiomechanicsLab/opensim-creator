...
#include <liboscar/graphics/textures/chequered_texture.h>
    ...
    private:
        static constexpr std::string_view c_vertex_shader_src = R"(
            ...
            void main()
            {
                ...
                // should try its best to render it "correct enough" (opensim-creator#168, opensim-creator#318)
...
private:
        ...
        const std::optional<Shadows>& maybe_shadow_map)
    {
        ...
        for (const SceneDecoration& dec : decorations) {
            ...
            // a solid color - even if `NoDrawInScene` is requested (opensim-creator#952).
