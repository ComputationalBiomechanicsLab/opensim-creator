#include "color_render_buffer_params.h"
...
TEST(ColorRenderBufferParams, changing_pixel_dimensions_changes_equality)
{
    const ColorRenderBufferParams lhs;
    const ColorRenderBufferParams rhs{.pixel_dimensions = {2, 2}};
    ASSERT_NE(lhs, rhs);
}
