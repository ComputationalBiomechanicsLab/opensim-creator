...
{
    const DAEMetadata metadata{OSCAR_TESTS_APPNAME_STRING, OSCAR_TESTS_APPNAME_STRING};
...
{
    DAEMetadata metadata{OSCAR_TESTS_APPNAME_STRING, OSCAR_TESTS_APPNAME_STRING};
