...
public:
    ...
    void on_draw()
    {
        ...
        const Rect lhs_screen_space_rect{workspace_screen_space_rect_corners.min, {x_midpoint, workspace_screen_space_rect_corners.max.y}};
        const Rect rhs_screen_space_rect = {{x_midpoint, workspace_screen_space_rect_corners.min.y}, workspace_screen_space_rect_corners.max};
