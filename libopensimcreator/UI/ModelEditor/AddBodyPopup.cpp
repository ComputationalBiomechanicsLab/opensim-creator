...
public:
    ...
    void draw_content()
    {
        ...
        // prompt name
        {
            ...
            App::upd().add_main_window_frame_annotation("AddBodyPopup::BodyNameInput", ui::get_last_drawn_item_screen_rect());
            ui::next_column();
        }
        ...
        // prompt body/ground that new body will connect to (via a joint)
        {
            ...
            for (const auto& pf : model.getComponentList<OpenSim::PhysicalFrame>()) {
                ...
                if (&pf == selectedPf) {
                    App::upd().add_main_window_frame_annotation(pf.getName(), ui::get_last_drawn_item_screen_rect());
                }
            }
            ui::end_child_panel();
            ui::next_column();
        ...
        // prompt joint type for the above
        {
            ...
            ui::next_column();
            {
                ...
                App::upd().add_main_window_frame_annotation("AddBodyPopup::JointTypeInput", ui::get_last_drawn_item_screen_rect());
            }
            ui::next_column();
        }
        ...
        // prompt joint name
        {
            ...
            App::upd().add_main_window_frame_annotation("AddBodyPopup::JointNameInput", ui::get_last_drawn_item_screen_rect());
            ui::next_column();
        }
        ...
        // prompt adding offset frames
        {
            ...
            App::upd().add_main_window_frame_annotation("AddBodyPopup::AddOffsetFramesInput", ui::get_last_drawn_item_screen_rect());
            ui::next_column();
        }
        ...
        // prompt geometry
        {
            ...
            ui::next_column();
            {
                ...
                App::upd().add_main_window_frame_annotation("AddBodyPopup::GeometryButton", ui::get_last_drawn_item_screen_rect());
            }
            ui::next_column();
        }
