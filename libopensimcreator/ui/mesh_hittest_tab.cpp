...
private:
    ...
    Mesh m_Mesh = opyn::LoadMeshViaSimbody(App::resource_filepath("OpenSimCreator/geometry/hat_ribs.vtp").value_or(std::filesystem::path{"OpenSimCreator/geometry/hat_ribs.vtp"}));
