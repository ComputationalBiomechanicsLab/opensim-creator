...
using namespace osc::ui::property_editor;
...
namespace {
    ...
    template<typename T>
    std::optional<Response> draw_editor(State&, OpenSim::Property<T> const&);

    // draw a `std::string` property editor
    template<>
    std::optional<Response> draw_editor<std::string>(
            State&,
    ...
    template<>
    std::optional<Response> draw_editor<double>(
            State& st,
    ...
    template<>
    std::optional<Response> draw_editor<bool>(
            State&,
    ...
    template<>
    std::optional<Response> draw_editor<SimTK::Vec3>(
            State& st,
    ...
    template<>
    std::optional<Response> draw_editor<SimTK::Vec6>(
            State&,
    ...
    template<>
    std::optional<Response> draw_editor<OpenSim::Appearance>(
            State&,
    ...
    using draw_editor_type_erased_fn = std::optional<Response>(State&, OpenSim::AbstractProperty const&);

    // template that generates a type-erased version of the `draw_editor` functions above
    template<typename T>
    std::optional<Response> draw_editor_type_erased(
            State& st,
...
std::optional<osc::ui::property_editor::Response> osc::ui::property_editor::draw(
        State& st,
        OpenSim::AbstractProperty const& prop) {
...
std::optional<osc::ui::properties_editor::Response> osc::ui::properties_editor::draw(
        State& st,
        OpenSim::Object& obj) {
