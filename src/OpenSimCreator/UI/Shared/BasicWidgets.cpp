    ...
    std::span<SceneDecoration const> drawlist)
{
    ...
    edited = SliderRadiansInDegrees("theta", params.camera.theta, 0_deg, 360_deg) || edited;
    edited = SliderRadiansInDegrees("phi", params.camera.phi, 0_deg, 360_deg) || edited;
    edited = SliderRadiansInDegrees("fov", params.camera.verticalFOV, 0_deg, 360_deg) || edited;
