...
#include <OpenSimCreator/UI/Simulation/SelectionDetailsPanel.hpp>
#include <OpenSimCreator/UI/Simulation/SimulationDetailsPanel.hpp>
#include <OpenSimCreator/UI/Simulation/SimulationViewerPanel.hpp>
