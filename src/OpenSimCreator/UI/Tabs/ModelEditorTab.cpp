...
#include <OpenSimCreator/UI/Panels/CoordinateEditorPanel.hpp>
...
#include <OpenSimCreator/UI/Panels/OutputWatchesPanel.hpp>
...
#include <OpenSimCreator/UI/Widgets/EditorTabStatusBar.hpp>
