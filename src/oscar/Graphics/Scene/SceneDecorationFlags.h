...
namespace osc
{
    ...
    enum class SceneDecorationFlag {
        None                 = 0,
        RimHighlight0        = 1<<0,  // the decoration should be highlighted with a colored rim (group #1)
        RimHighlight1        = 1<<1,  // the decoration should be highlighted with a colored rim (group #2)
