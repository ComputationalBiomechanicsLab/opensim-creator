...
static bool EnsureOpenSimInitialized(osc::Config const& config, std::filesystem::path const& geometryDir)
{
    static bool initializeOnceGlobally = [&config, &geometryDir]()
    {
