...
#include "src/Utils/PropertySystem/ComponentList.hpp"
#include "src/Utils/PropertySystem/ComponentMemberOffset.hpp"
...
void osc::Component::setName(std::string_view newName)
{
