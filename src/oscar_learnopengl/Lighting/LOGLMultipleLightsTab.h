...
namespace osc
{
    ...
    public:
        ...
        explicit LOGLMultipleLightsTab(const ParentPtr<ITabHost>&);
        LOGLMultipleLightsTab(const LOGLMultipleLightsTab&) = delete;
        LOGLMultipleLightsTab(LOGLMultipleLightsTab&&) noexcept;
        LOGLMultipleLightsTab& operator=(const LOGLMultipleLightsTab&) = delete;
