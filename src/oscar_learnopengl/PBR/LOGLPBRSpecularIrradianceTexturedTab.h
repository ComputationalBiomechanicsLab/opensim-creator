...
namespace osc
{
    ...
    public:
        ...
        LOGLPBRSpecularIrradianceTexturedTab(const LOGLPBRSpecularIrradianceTexturedTab&) = delete;
        LOGLPBRSpecularIrradianceTexturedTab(LOGLPBRSpecularIrradianceTexturedTab&&) noexcept;
        LOGLPBRSpecularIrradianceTexturedTab& operator=(const LOGLPBRSpecularIrradianceTexturedTab&) = delete;
