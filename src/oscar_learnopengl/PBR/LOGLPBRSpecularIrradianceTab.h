...
namespace osc
{
    ...
    public:
        ...
        explicit LOGLPBRSpecularIrradianceTab(const ParentPtr<ITabHost>&);
        LOGLPBRSpecularIrradianceTab(const LOGLPBRSpecularIrradianceTab&) = delete;
        LOGLPBRSpecularIrradianceTab(LOGLPBRSpecularIrradianceTab&&) noexcept;
        LOGLPBRSpecularIrradianceTab& operator=(const LOGLPBRSpecularIrradianceTab&) = delete;
