#include "math_experiments_screen.hpp"
...
struct osc::Math_experiments_screen::Impl final {
    bool checkbox_state = false;
};

// public API

osc::Math_experiments_screen::Math_experiments_screen() :
    m_Impl{new Impl{}} {
}

osc::Math_experiments_screen::~Math_experiments_screen() noexcept = default;

void osc::Math_experiments_screen::on_mount() {
...
void osc::Math_experiments_screen::on_unmount() {
...
void osc::Math_experiments_screen::on_event(SDL_Event const& e) {
...
void osc::Math_experiments_screen::tick(float) {
...
void osc::Math_experiments_screen::draw() {
