#include "LayeredInterfaceScreen.hpp"
...
struct osc::LayeredInterfaceScreen::Impl final {
    bool checkboxState = false;
};

// public API

osc::LayeredInterfaceScreen::LayeredInterfaceScreen() :
    m_Impl{new Impl{}}
{
}

osc::LayeredInterfaceScreen::~LayeredInterfaceScreen() noexcept = default;

void osc::LayeredInterfaceScreen::onMount()
{
...
void osc::LayeredInterfaceScreen::onUnmount()
{
...
void osc::LayeredInterfaceScreen::onEvent(SDL_Event const& e)
{
...
void osc::LayeredInterfaceScreen::tick(float)
{
...
void osc::LayeredInterfaceScreen::draw()
{
