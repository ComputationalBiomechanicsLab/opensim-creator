...
namespace osc
{
    ...
    public:
        ...
        explicit FrustrumCullingTab(const ParentPtr<ITabHost>&);
        FrustrumCullingTab(const FrustrumCullingTab&) = delete;
        FrustrumCullingTab(FrustrumCullingTab&&) noexcept;
        FrustrumCullingTab& operator=(const FrustrumCullingTab&) = delete;
